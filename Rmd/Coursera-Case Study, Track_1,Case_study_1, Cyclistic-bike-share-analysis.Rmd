...
> summary(Cyclistic_df$start_lng)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 -87.92  -87.66  -87.64  -87.65  -87.63  -73.80 
> summary(Cyclistic_df$end_lat)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00   41.88   41.90   41.90   41.93   42.37    8862 
> summary(Cyclistic_df$end_lng)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
 -88.16  -87.66  -87.64  -87.65  -87.63    0.00    8862 
...
> summary(Cyclistic_df_No_Zero$start_lat)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
  41.65   41.88   41.90   41.90   41.93   45.64 
> summary(Cyclistic_df_No_Zero$start_lng)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 -87.84  -87.66  -87.64  -87.64  -87.63  -73.80 
> summary(Cyclistic_df_No_Zero$end_lat)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
  41.65   41.88   41.90   41.90   41.93   42.06 
> summary(Cyclistic_df_No_Zero$end_lng)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 -87.84  -87.66  -87.64  -87.65  -87.63  -87.53 
...
### Anaylisis Conclusions

##### *Pending Review... taking notes as as I go... to be re-written and finalized...*

So far...

Members ride way more often for way shorter distances, and their highest usage is June, July, and August, with a taper effect on either side, May/September.

I'll still be looking at more slices. But so far, it looks like a Campaign from May to September, with a focus on casual riders who do shorter rides more frequently.
...
1.  
    ...
    1.  Determine the best way to share your findings. 2. Create effective data visualizations. 3. Present your findings. 4. Ensure your work is accessible.
...
1.  
    ...
    1.  Create your portfolio. 2. Add your case study. 3. Practice presenting your case study to a friend or family member.
